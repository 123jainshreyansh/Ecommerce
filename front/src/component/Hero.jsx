...
function Background({heroData, heroCount, setHeroCount}) {
  return (
    <div className="w-[40%] h-full relative">
      <div className="absolute text-[#88d9ee] text-5 md:text-[40px] lg:text-[55px] md:left-[10%] md:top-22.5 lg:top-32.5 left-[10%] top-2.5 ">
        <p>{heroData.text1}</p>
        <p>{heroData.text2}</p>
      </div>
